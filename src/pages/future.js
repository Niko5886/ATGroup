...
export function futurePage() {
  return `
    ...
    <section class="service-grid service-grid-4">
      <article class="service-card service-card-violet service-card-microsoft-365 service-card-clickable" data-card-link="/microsoft-365" tabindex="0" role="link" aria-label="Настройка на Microsoft 365 и Одити на Сигурността">
      ...
      <article class="service-card service-card-violet service-card-email-security service-card-clickable" data-card-link="/email-security" tabindex="0" role="link" aria-label="Сигурност на Имейли">
      ...
      <article class="service-card service-card-violet service-card-ai-integration service-card-clickable" data-card-link="/ai-integration" tabindex="0" role="link" aria-label="Консултации за Интеграция на AI">
      ...
      <article class="service-card service-card-violet service-card-process-automation service-card-clickable" data-card-link="/process-automation" tabindex="0" role="link" aria-label="Автоматизация на Процеси">
